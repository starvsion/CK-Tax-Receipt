<template>
    ...
    >
        ...
        <el-form-item>
            <el-button native-type="submit" class="login-button" type="primary" block>
                Login 登錄
            </el-button>
        </el-form-item>
        <el-form-item>
            <el-button
                ...
                type="info"
                @click.prevent="authProvider.loginWithGoogle"
            >
...
export default {
    ...
    methods: {
        async login () {
            ...
            this.authProvider.login(this.model);
        },
    },
};
</script>
